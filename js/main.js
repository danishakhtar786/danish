    ...
    var imJs = {
        ...
        vedioActivation: function (e) {
            $('#play-video').on('click', function (e) {
                ...
                $("#video-overlay").append('<iframe width="80%" height="80%" src="https://www.youtube.com/embed/JqEwFpJAdDo" frameborder="0" allowfullscreen></iframe>');
            });
			 ...
			 $('#play-video1').on('click', function (e) {
                e.preventDefault();
                $('#video-overlay').addClass('open');
                $("#video-overlay").append('<iframe width="80%" height="80%" src="https://www.youtube.com/embed/mCo-hOdpM-A" frameborder="0" allowfullscreen></iframe>');
            });
			
			 $('#play-video2').on('click', function (e) {
                e.preventDefault();
                $('#video-overlay').addClass('open');
                $("#video-overlay").append('<iframe width="80%" height="80%" src="https://www.youtube.com/embed/M4dWfQfuZvw" frameborder="0" allowfullscreen></iframe>');
            });
