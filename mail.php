...
if ($name == "") {
    ...
    $headers .= 'From:  Danish Akhtar <info@danishakhtar.com>' . "\r\n";
    $headers .= 'cc: info@danishakhtar.com' . "\r\n";
    $headers .= 'bcc: info@danishakhtar.com' . "\r\n";
    mail($to, $subject, $_message, $headers, '-f danishkhushI@gmail.com);
